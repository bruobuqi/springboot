...
public class GetListContentTypeResponse {
    ...
    protected GetListContentTypeResult getListContentTypeResult;

    /**
     * ��ȡgetListContentTypeResult���Ե�ֵ��
     * 
     * @return
     *     possible object is
     *     {@link GetListContentTypeResult }
     *     
     */
    public GetListContentTypeResult getGetListContentTypeResult() {
        return getListContentTypeResult;
    }

    /**
     * ����getListContentTypeResult���Ե�ֵ��
     * 
     * @param value
     *     allowed object is
     *     {@link GetListContentTypeResult }
     *     
     */
    public void setGetListContentTypeResult(GetListContentTypeResult value) {
