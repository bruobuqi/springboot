...
public class UpdateContentTypeXmlDocumentResponse {
    ...
    protected UpdateContentTypeXmlDocumentResult updateContentTypeXmlDocumentResult;

    /**
     * ��ȡupdateContentTypeXmlDocumentResult���Ե�ֵ��
     * 
     * @return
     *     possible object is
     *     {@link UpdateContentTypeXmlDocumentResult }
     *     
     */
    public UpdateContentTypeXmlDocumentResult getUpdateContentTypeXmlDocumentResult() {
        return updateContentTypeXmlDocumentResult;
    }

    /**
     * ����updateContentTypeXmlDocumentResult���Ե�ֵ��
     * 
     * @param value
     *     allowed object is
     *     {@link UpdateContentTypeXmlDocumentResult }
     *     
     */
    public void setUpdateContentTypeXmlDocumentResult(UpdateContentTypeXmlDocumentResult value) {
