...
public class GetListCollectionResponse {
    ...
    protected GetListCollectionResult getListCollectionResult;

    /**
     * ��ȡgetListCollectionResult���Ե�ֵ��
     * 
     * @return
     *     possible object is
     *     {@link GetListCollectionResult }
     *     
     */
    public GetListCollectionResult getGetListCollectionResult() {
        return getListCollectionResult;
    }

    /**
     * ����getListCollectionResult���Ե�ֵ��
     * 
     * @param value
     *     allowed object is
     *     {@link GetListCollectionResult }
     *     
     */
    public void setGetListCollectionResult(GetListCollectionResult value) {
