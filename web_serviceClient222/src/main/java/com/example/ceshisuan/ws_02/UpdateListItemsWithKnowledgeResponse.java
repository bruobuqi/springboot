...
public class UpdateListItemsWithKnowledgeResponse {
    ...
    protected UpdateListItemsWithKnowledgeResult updateListItemsWithKnowledgeResult;

    /**
     * ��ȡupdateListItemsWithKnowledgeResult���Ե�ֵ��
     * 
     * @return
     *     possible object is
     *     {@link UpdateListItemsWithKnowledgeResult }
     *     
     */
    public UpdateListItemsWithKnowledgeResult getUpdateListItemsWithKnowledgeResult() {
        return updateListItemsWithKnowledgeResult;
    }

    /**
     * ����updateListItemsWithKnowledgeResult���Ե�ֵ��
     * 
     * @param value
     *     allowed object is
     *     {@link UpdateListItemsWithKnowledgeResult }
     *     
     */
    public void setUpdateListItemsWithKnowledgeResult(UpdateListItemsWithKnowledgeResult value) {
