...
public class GetListItemChangesWithKnowledgeResponse {
    ...
    protected GetListItemChangesWithKnowledgeResult getListItemChangesWithKnowledgeResult;

    /**
     * ��ȡgetListItemChangesWithKnowledgeResult���Ե�ֵ��
     * 
     * @return
     *     possible object is
     *     {@link GetListItemChangesWithKnowledgeResult }
     *     
     */
    public GetListItemChangesWithKnowledgeResult getGetListItemChangesWithKnowledgeResult() {
        return getListItemChangesWithKnowledgeResult;
    }

    /**
     * ����getListItemChangesWithKnowledgeResult���Ե�ֵ��
     * 
     * @param value
     *     allowed object is
     *     {@link GetListItemChangesWithKnowledgeResult }
     *     
     */
    public void setGetListItemChangesWithKnowledgeResult(GetListItemChangesWithKnowledgeResult value) {
