...
public class GetListItemChangesResponse {
    ...
    protected GetListItemChangesResult getListItemChangesResult;

    /**
     * ��ȡgetListItemChangesResult���Ե�ֵ��
     * 
     * @return
     *     possible object is
     *     {@link GetListItemChangesResult }
     *     
     */
    public GetListItemChangesResult getGetListItemChangesResult() {
        return getListItemChangesResult;
    }

    /**
     * ����getListItemChangesResult���Ե�ֵ��
     * 
     * @param value
     *     allowed object is
     *     {@link GetListItemChangesResult }
     *     
     */
    public void setGetListItemChangesResult(GetListItemChangesResult value) {
