...
public class GetListAndViewResponse {
    ...
    protected GetListAndViewResult getListAndViewResult;

    /**
     * ��ȡgetListAndViewResult���Ե�ֵ��
     * 
     * @return
     *     possible object is
     *     {@link GetListAndViewResult }
     *     
     */
    public GetListAndViewResult getGetListAndViewResult() {
        return getListAndViewResult;
    }

    /**
     * ����getListAndViewResult���Ե�ֵ��
     * 
     * @param value
     *     allowed object is
     *     {@link GetListAndViewResult }
     *     
     */
    public void setGetListAndViewResult(GetListAndViewResult value) {
