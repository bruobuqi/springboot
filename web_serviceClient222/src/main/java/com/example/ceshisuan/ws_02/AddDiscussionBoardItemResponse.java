...
public class AddDiscussionBoardItemResponse {
    ...
    protected AddDiscussionBoardItemResult addDiscussionBoardItemResult;

    /**
     * ��ȡaddDiscussionBoardItemResult���Ե�ֵ��
     * 
     * @return
     *     possible object is
     *     {@link AddDiscussionBoardItemResult }
     *     
     */
    public AddDiscussionBoardItemResult getAddDiscussionBoardItemResult() {
        return addDiscussionBoardItemResult;
    }

    /**
     * ����addDiscussionBoardItemResult���Ե�ֵ��
     * 
     * @param value
     *     allowed object is
     *     {@link AddDiscussionBoardItemResult }
     *     
     */
    public void setAddDiscussionBoardItemResult(AddDiscussionBoardItemResult value) {
