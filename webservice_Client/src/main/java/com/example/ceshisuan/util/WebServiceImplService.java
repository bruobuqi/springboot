 ...
 * 
 */
@WebServiceClient(name = "WebServiceImplService", targetNamespace = "http://impl.ws_demo/", wsdlLocation = "http://localhost:8081/wsServeice?wsdl")
    ...
    extends Service
{
    ...
    private final static QName WEBSERVICEIMPLSERVICE_QNAME = new QName("http://impl.ws_demo/", "WebServiceImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8081/wsServeice?wsdl");
    ...
    public WebServiceImpl getWebServiceImplPort() {
        return super.getPort(new QName("http://impl.ws_demo/", "WebServiceImplPort"), WebServiceImpl.class);
    }
    ...
    public WebServiceImpl getWebServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://impl.ws_demo/", "WebServiceImplPort"), WebServiceImpl.class, features);
    }
